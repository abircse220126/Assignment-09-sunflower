...
//           {
//             user?
//             <NavLink to="/login"><button onClick={handleLogOut}
//              className="btn btn-primary">Logout</button></NavLink>
//              :<NavLink to="/register"><button className="btn btn-primary">SignUp</button></NavLink>
//           }
//           </div>
